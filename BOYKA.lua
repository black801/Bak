...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/black801/Bak/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,835551362,1622822810,835551362}   
...
os.execute('wget https://raw.githubusercontent.com/black801/Bak/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' ✪ تم تحديث السورس \n ✪ لديك اخر اصدار ل𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒂𝒌𝒂𝒓 \n ✪ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ✪' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✪ اصدار 𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒂𝒌𝒂𝒓  \n ✪ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ✪' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✪ [تحديثات البوت](t.me/alaziza1) \n ✪ [قناه السورس](t.me/BK_bh1)')
end
...
local Text = [[
𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴.😸
مرحبا بك في سورس بكار الاقوي 💙
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '┓ المبرمج ┏ ',url="t.me/UU_bh"}},
{{text = '┓ قناه السورس ┏ ',url="t.me/BK_bh1"}},
}
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/black801/Bak/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/black801/Bak/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_," ✪ عذرا الملف لايدعم 𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒂𝒌𝒂𝒓  \n") 
end
return false
end
...
{
{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒂𝒌𝒂𝒓  ', url="t.me/BK_bh1"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
