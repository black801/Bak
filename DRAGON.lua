...
if res ~= 200 then
print('\27[0;31m𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.write('\27[1;31m 𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍 𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍"
exit 1
fi
if [ ! $token ]; then
echo "𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍 𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍"
...
token = sudos.token 
--- start functions 𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍
--------------------------------------------------------------------------------------------------------------
...
var = true 
if tonumber(user_id) == tonumber(1890233810) then  
var = true 
...
elseif tonumber(user_id) == tonumber(968613145) then
var = 'صاحب التليجرام'
elseif tonumber(user_id) == tonumber(1890233810) then
var = 'صاحب السورس'
elseif tonumber(user_id) == tonumber(1759990986) then
var = 'مالك السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
...
local Text = ' 🕊تم ارسال الملصق من 𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍\n - '..Name
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج تيتو لو حابب تتواصل معاه
اتبع الزر إلى تحت 𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ASALIYA  🇦🇪', url="t.me/AsaliyaEgypt"}}, 
...
╭𖤍━┅⟞⟦[𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶](http://t.me/V_I_K_I_N_G_1)⟧⟝┉━𖤍╮

 [⟦W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧](http://t.me/V_I_K_I_N_G_1)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ¹',url="t.me/AsaliyaEgypt"},{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ²', url="t.me/e2_c11"}},
{{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ³',url="t.me/Zika120"},{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ⁴', url="t.me/@Oxy_gen8"}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶》',url="t.me/V_I_K_I_N_G_1"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 𖠪 اهلا بك في سورس فايكينج الجمدان 𖠪
 𖠪 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖠪  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ASALIYA  🇦🇪',url="t.me/AsaliyaEgypt"},{text = ' ᴛ ᴇ ᴛ ᴏ - ᴏғғʟɪɴᴇ 🇦🇪', url="t.me/e2_c11"}},
{{text = 'ZIKA 🇦🇪',url="t.me/Zika120"},{text = ' OXTGEN 🇦🇪',url="t.me/Oxy_gen8"}}, 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶》 ', url="t.me/V_I_K_I_N_G_1"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'زيكوا' or text == 'زيكا' or text == 'مالك السورس'  then
local Text = [[
...
if text == 'تيتو' or text == 'عقرب' or text == 'صاحب التليجرام'  then
local Text = [[
تيتو صاحب التليجرام فايكينج للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(result.sender_user_id_) == tonumber(1890233810) then  
...
if result.id_ == tonumber(1890233810) then
...
if result.id_ == tonumber(1759990986) then
...
if tonumber(userid) == tonumber(1890233810) then  
send(msg.chat_id_, msg.id_, " 🕊 لا تسطيع حظر صاحب السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1759990986) then  
send(msg.chat_id_, msg.id_, " 🕊 لا تسطيع حظر مالك السورس عام")
return false 
end
...
t = ' 🕊 ملفات السورس فايكينج𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍\n 𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
send(msg.chat_id_, msg.id_, t..'𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍\nاضغط علي الاسم ليتم نسخه\n𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍ٴ\n 🕊 ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶》 ](t.me/V_I_K_I_N_G_1)❳ 🕊 ')
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🕊💕](t.me/V_I_K_I_N_G_1)')
return false
end
end
end
...
[[
🌨𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍Use ⇨ #username 🌨
🌨𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍iD ⇨ #id 🌨
🌨𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍Sta ⇨  #stast 🌨
🌨𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍Msg ⇨ #msgs 🌨
🌨𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 🕊  
↑𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍𝙄𝘿 ➱ #id
↑𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍𝙍𝘼𝙉𝙆 ➱  #stast 🕊  
↑𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍𝙈𝘼𝙎𝙂 ➱ #msgs 🕊  
↑𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍𝗖𝗛 ➯  ↝@V_I_K_I_N_G_1↜ 🕊  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
send(msg.chat_id_,msg.id_,'\n 🕊 اهلا عزيزي البوت هنا ادمن'..'\n 🕊 وصلاحياته هي 𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍 \n━━━━━━━━━━'..'\n 🕊 تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 🕊 مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n 🕊 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 🕊 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 🕊 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 🕊 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍
 اختر الامر الذي تريدها .↑𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍
ده من الازرار بلاسفل . 𖤍━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖤍
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶》 ](t.me/V_I_K_I_N_G_1)❳ 
]]
keyboard = {} 
