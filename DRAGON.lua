...
sudo_users = {SUDO,1797771210,1720330493,1866198149}   
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝒕𝒘𝒂𝒔𝒐𝒍𓆪', url="t.me/U440p_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ☁️ العضو » ['..result.title_..'](t.me/'..(username or 'U440p')..')'
status  = '\n ☁️ تم ترقيته مطور'
...
usertext = '\n ☁️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
status  = '\n ☁️ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☁️ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'U440p')..') \n ☁️ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0, " ☁️ عذرا » {["..data.first_name_.."](T.ME/U440p)}\n ☁️ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑨𝑲𝑨𝑹𓆪', url="t.me/U440p"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑨𝑲𝑨𝑹𓆪', url="t.me/U440p_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☁️ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'U440p')..') \n ☁️ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☁️ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'U440p')..') \n ☁️ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " ☁️ لا يمكنك حظر ملك التلجرام\n")
return false 
end
...
if result.sender_user_id_ == tonumber(1866198149) then
send(msg.chat_id_, msg.id_, " ☁️ لا يمكنك كتم ملك التلجرام\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☁️ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
status  = '\n ☁️ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☁️ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☁️ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☁️ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'U440p')..')'..'\n ☁️ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/U440p)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/U440p)')
return false
end
end
end
...
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑨𝑲𝑨𝑹 𝒃𝒂𝒌𝒂𝒓', url="t.me/U440p"},
