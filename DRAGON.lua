...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝗕𝗸 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝗕𝗸 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝗕𝗸 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua Bakar.lua')
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Bakar.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Bakar -X kill
screen -S Bakar ./Bakar
done
]])  
file:close() 
...
sudo_users = {SUDO,1464890548,835551362}   
...
local UserName = (data.username_ or "UU_b_h")
...
local Bakar_Msg = ''  
if msgs < 100 then 
Bakar_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Bakar_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Bakar_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Bakar_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Bakar_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Bakar_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Bakar_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Bakar_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Bakar_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Bakar_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Bakar_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Bakar_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Bakar_Msg = 'رب التفاعل'  
end 
return Bakar_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝙨𝙤𝙪𝙧𝙘𝙚𝚂 𝗕𝗮𝗸𝗮𝗿.")  
...
function plugin_Bakar(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Bakar and msg then
pre_msg = plugin.Bakar(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBakar(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Bakar_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf Bakar.lua')
os.execute('wget https://raw.githubusercontent.com/black801/Bak/main/Bakar.lua')
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس بـكار\n ℘︙ الاصدار » { v 1.5}')
dofile('Bakar.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس بـكار \n ℘︙ الاصدار »{ v 1.5}')
end
...
send(msg.chat_id_, msg.id_,'℘︙  عدد الجروبات الان » { '..#group..' }'..Bakark..''..Bakar..'\n℘︙  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'UU_b_h')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_b_h')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
local Bakar1_Msg = database:get(bot_id.."Bakar1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Bakar1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UU_b_h')..') \n ℘︙ '..Bakar1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Bakar_Msg and not Special(msg) then  
local Bakar_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Bakar_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..Bakar_Msg.."] \n")
else
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/UU_b_h)}\n ℘︙ ["..Bakar_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](T.ME/UU_b_h)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."Bakar:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Bakar:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."Bakar:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."Bakar:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Bakar:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Bakar:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Bakar:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Bakar:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."Bakar:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Bakar:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."Bakar:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."Bakar:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Bakar:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "UU_b_h")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Bakar:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local BakarChengName = database:get(bot_id.."Bakar:Cheng:Name"..data.id_)
if not data.first_name_ then 
if BakarChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BakarChengName..']')
database:del(bot_id.."Bakar:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BakarChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Bakar:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local BakarChengUserName = database:get(bot_id.."Bakar:Cheng:UserName"..data.id_)
if not data.username_ then 
if BakarChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BakarChengUserName..']')
database:del(bot_id.."Bakar:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BakarChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Bakar:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BakarChengPhoto = database:get(bot_id.."Bakar:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BakarChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Bakar:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BakarChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Bakar:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [𝗕𝗮𝗸𝗮𝗿  ](t.me/UU_b_h)
℘︙ [❀ 𝐃𝐄𝐕¹ ļ 𝐁𝐋𝐀𝐂𝐊 𝐇𝐎𝐔𝐒𝐄](t.me/UU_bh)     
℘︙ [𝐃𝐄𝐕²𝑩𝑨𝑻𝑶𝑻 ](t.me/DV_AL7) 
℘︙ [𝐒𝐎𝐔𝐑𝐂𝐄 𝗕𝗮𝗸𝗮𝗿  ](t.me/UU_b_h) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS Bakar](t.me/UU_b_hbot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UU_b_h')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UU_b_h')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات بـكار\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝗕𝗸 ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ 𝗕𝗸 ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس بـكار ↓\n".." ℘︙ [اضغط هنا لدخول](t.me/UU_b_h) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس بـكار \n") 
end
return false
end
...
local UserName = (b.username_ or "SRC-Bakar")
...
function Function_Bakar(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Bakar, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Bakar, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_b_h')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_b_h')..')'
...
database:set(bot_id.."Bakar1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Bakar1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ℘︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Bakar1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Bakar1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Bakar1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Bakar1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ℘︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."Bakar1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Bakar1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Bakar1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Bakar1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ℘︙ ارسل الكلمه الان")  
database:set(bot_id.."Bakar1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Bakar1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Bakar1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Bakar1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Bakar1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Bakar1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Bakar1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Bakar1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Bakar1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ℘︙ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ 𝗕𝗸 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local Bakar_Msg = database:get(bot_id.."Bakar1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Bakar_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'UU_b_h')..')'..'\n ℘︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بـكار').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بـكار')
local Bakar_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..Bakar_Msg[math.random(#Bakar_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Bakar:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:Bakar:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Bakar:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Bakar:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Bakar:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:Bakar:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Bakar:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Bakar:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Bakar:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Bakar:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:Bakar:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Bakar:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Bakar:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Bakar:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Bakar:List:Rd:Sudo")
end
...
if text == "غنيلي" then
data,res = https.request('https://bld/Black/audios.php')
if res == 200 then
...
database:set(bot_id.."UU_b_h:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."UU_b_h:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."UU_b_h:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."UU_b_h:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."UU_b_h:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."UU_b_h:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس بـكار يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:Bakar:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:Bakar:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:Bakar:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Bakar:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Bakar:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Bakar:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Bakar:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Bakar:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Bakar:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Bakar:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Bakar:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Bakar:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Bakar:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Bakar:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"℘︙تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:Bakar:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Bakar:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Bakar:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بـكار').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_b_h')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Bakardx(msg.chat_id_, msg.id_, ' ℘︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ℘︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ℘︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ℘︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝗕𝗮𝗸𝗮𝗿 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/UU_b_h"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝗕𝗸 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝙨𝙤𝙪𝙧𝙘𝙚𝚂 𝗕𝗮𝗸𝗮𝗿. ](t.me/UU_b_h)➤ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بـكار')
...
Bakar = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Bakar)
...
--------------------------------------------------------------------------------------------------------------
SourceBakar(data.message_,data)
plugin_Bakar(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local BakarAbot = database:get(bot_id.."Bakar1:Add:Filter:Rp2"..text..result.chat_id_)   
if BakarAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..BakarAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Bakar1_Msg = database:get(bot_id.."Bakar1:Add:Filter:Rp2"..text..result.chat_id_)   
if Bakar1_Msg then    
send(msg.chat_id_, msg.id_," ℘︙ "..Bakar1_Msg)
